...
public class EstadoCivilDTO {
	...
	/**
	 * <ul>
	 * <li>Propiedad que representa el código de un estado civil.</li>
	...
	/**
	 * <ul>
	 * <li>Propiedad que representa el nombre de un estado civil.</li>
	 * <li>Es un dato de tipo texto.</li>
	 * <li>Sólo permite letras y espacios.</li>
	 * <li>Su longitud máxima es de 100 caracteres.</li>
	 * <li>El nombre de un estado civil no se puede repetir.</li>
	 * <li>Es un dato obligatorio.</li>
	 * </ul>
	 */
