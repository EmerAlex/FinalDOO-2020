...
public class TipoProgramaDTO {
	...
	/**
	 * <ul>
	 * <li>Propiedad que representa el código de un tipo de programa.</li>
	...
	/**
	 * <ul>
	 * <li>Propiedad que representa el nombre de un tipo de programa.</li>
	 * <li>Es un dato de tipo texto.</li>
	 * <li>Sólo permite letras y espacios.</li>
	 * <li>Su longitud máxima es de 100 caracteres.</li>
	 * <li>El nombre de un tipo de programa no se puede repetir.</li>
	 * <li>Es un dato obligatorio.</li>
	 * </ul>
	 */
